...
public class CategoryRepositoryTest {
    ...
    public void givenAnInvalidNullName_whenCallsSave_shouldReturnError() {
        ...
        final var actualException = //exception generica que o spring usa para encapsular o problema
                Assertions.assertThrows(DataIntegrityViolationException.class, () -> categoryRepository.save(anEntity));

        final var actualCause = //verificamos que a causa raiz é do tipo PropertyValueException, que é a exc do Hibernate que realmente valida
