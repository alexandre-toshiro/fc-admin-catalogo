...
public class ListCategoriesUseCaseIT {
    ...
    void mockUp() {
        ...
        // Garanta que cada entidade tenha um createdAt crescente, simulando ordem de criação previsível
        //feito, pois o H2 nao lida mto bem com Instante
        int i = 0;
        for (CategoryJpaEntity entity : categories) {
            entity.setCreatedAt(Instant.ofEpochMilli(now + i * 1000L)); // Corrige para Instant
            i++;
        }
    ...
    public void givenAValidTerm_whenTermDoesntMatchsPrePersisted_shouldReturnEmptyPage() {
        ...
        final var expectedTerms = "asoidiosadiousa";
