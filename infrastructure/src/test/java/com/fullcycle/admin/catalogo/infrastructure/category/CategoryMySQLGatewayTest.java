...
public class CategoryMySQLGatewayTest {
    ...
    public void givenAPrePersistedCategoryAndAValidCategoryId_whenTryToDeleteIt_shouldDeleteCategory() {
        ...
        categoryGateway.deleteById(filmes.getId());
    ...
    @Test
    public void givenAPrePersistedCategoryAndAValidCategoryId_whenCallsFindById_shouldReturnCategory() {
        final var expectedName = "Filmes";
        final var expectedDescription = "A Categoria mais assistida";
        final var expectedIsActive = true;
    ...
    public void givenPrePersistedCategoriesAndDocAsTerms_whenCallsFindAllAndTermsMatchsCategoryName_shouldReturnPaginated() {
        ...
        //usa o termo doc para filtrar, no caso trara apenas o DOCumentarios
    ...
    @Test
    public void givenPrePersistedCategoriesAndMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchsCategoryName_shouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 1;
