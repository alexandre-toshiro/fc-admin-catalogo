...
public class CategoryController implements CategoryAPI {
    ...
    public CategoryController(final CreateCategoryUseCase createCategoryUseCase, GetCategoryByIdUseCase getCategoryByIdUseCase, UpdateCategoryUseCase updateCategoryUseCase) {
    ...
    @Override
    public ResponseEntity<?> updateById(final String id, final CreateCategoryApiInput input) {
